...
#define KERNEL_CS    ((GD_KTEXT) | DPL_KERNEL)        //相当于cpl和rpl   8
#define KERNEL_DS    ((GD_KDATA) | DPL_KERNEL)          // 16
#define USER_CS        ((GD_UTEXT) | DPL_USER)          // 27
#define USER_DS        ((GD_UDATA) | DPL_USER)          //35
